...
// Create the Schema for the Register and Login
        ...
        >
            {({
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    >
                        {/* Check if register is true, if true add additional form fields to the existing ones */}
                        {isRegister && (
                            <>
                                <TextField
                        ...
                        {/* show the email and password fields always */}
                        <TextField
                            label="Email"
                            onBlur={handleBlur}
                            onChange={handleChange}
